...
// Unit test for the key generator
// Generating 16 set of keys as per the standard
/*int main(){
	keyGen obj("0001001100110100010101110111100110011011101111001101111111110001");
	obj.print();
	std::vector<char> v;
	for(int j=1;j<17;++j){
		v=obj.GenerateKey(j);
